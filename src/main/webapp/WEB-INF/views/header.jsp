		...
		<div class="row">
			<div class="col-sm-3 toogle info_toogle text-left">
				<a href="https://www.facebook.com/" data-toggle="tooltip"
					data-placement="bottom" title="Facebook" class="social"
					target="_blank"><i class="fa fa-facebook"
					style="font-size: 17px; color: white"></i></a> <a
					href="https://twitter.com/" data-toggle="tooltip"
					data-placement="bottom" title="Twitter" class="social"
					target="_blank"><i class="fa fa-twitter"
					style="font-size: 17px; color: white"></i></a> <a
					href="https://www.youtube.com" data-toggle="tooltip"
					data-placement="bottom" title="Youtube" class="social"
					target="_blank"><i class="fa fa-youtube-play"
					style="font-size: 17px; color: white"></i></a> <a
					href="https://plus.google.com" data-toggle="tooltip"
					data-placement="bottom" title="Google+" class="social"
			...
			<div class="col-sm-9 info text-right">
				...
				nitishsmithcomputer@gmail.com <span
					class="glyphicon glyphicon-earphone"></span> +919031541640
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-sm-11">
				<div class="companyname">
					<marquee behavior="alternate">RHODE ISLAND HEALTH
						INSURANCE SYSTEM TELENGANA</marquee>
				</div>
			</div>
		</div>
	</div>
