		...
		<div id="product">
			<div class="container my_course_red">
				...
				<div class="container">
					...
					<!-- Form Name -->
					<form:form action="listCaseWorker" method="post"
						modelAttribute="listCaseWorker" id="userRegForm"
						name="userRegForm" style="max-width:1000px;margin:auto">

						<c:if test="${result ne null}">
							<h5 class="text-right" style="color: red">
								Hi,${result}<br>
							</h5>
						</c:if>
						<h4 class="text-center"
							style="color: #ff0000; background: #00ffbf; border-radius: 5px;">Case
							Worker Records</h4>
								...
								<tbody>
									<c:forEach items="${caseWorker}" var="cw" varStatus="index">
										<tr>
											...
											<td><a href="editCW?uid=${cw.userId}" title="Edit"
												data-toggle="tooltip"><span
													class="glyphicon glyphicon-pencil"></span></a></td>
											<td><c:if test="${cw.activeSw=='Y'}">
									...
									<div class="pagination">
										...
										<c:forEach begin="1" end="${tp}" var="pn">
											<c:choose>
												...
												<c:otherwise>
													<a href="listCaseWorker?cpn=${pn}"> <c:out
															value="${pn}" />
													</a>&nbsp;&nbsp;&nbsp;
   			</c:otherwise>
											</c:choose>
