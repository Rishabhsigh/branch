...
<body>
	<div class="container my_course_red">
		<form:form action="editCaseWorker" method="POST" name="regUserForm"
			id="userRegForm1" modelAttribute="editCW" class="form-horizontal"
			style="max-width:400px;margin:auto">
			<h4 class="text-center"
				style="color: #ff0000; background: #00ffbf; border-radius: 5px;">Update
				Case Worker Informations</h4>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<form:input path="email" class="form-control" readonly="false"
						id="email" />
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<form:input path="dob" class="form-control" readonly="false"
						id="datepicker" />
				</div>
			</div>
			...
			<input type="submit" id="userSaveBtn" value="Update" class="btn2"
