	...
	<div class="row">
			...
			<div id="my_slide" class="carousel slide" data-ride="carousel"
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="./resources/images/main_top_bg.jpg"
					...
					<div class="item">
						...
						<div class="carousel-caption wow bounceInDown"
							data-wow-duration="3s">
				...
				<a class="left carousel-control" href="#my_slide" data-slide="prev"><span
					class="glyphicon glyphicon-chevron-left"></span></a> <a
					class="right carousel-control" href="#my_slide" data-slide="next"><span
		...
		<div class="col-sm-5 col-sd-5 col-xs-12">
			<form:form action="login" method="post" modelAttribute="login"
				...
				<h5 class="text-center" style="color: white; font-weight: bolder;">Login
					Admin / Case Worker</h5>
				<img class="img img-responsive img-circle"
					src="resources/images/login.gif">
				<div class="text-center" id="resultAll"></div>
				<div class="text-center"
					style="color: red; font-size: 15px; font-weight: bold;">${ERROR}</div>
				<c:if test="${param.ac eq 'lo'}">
					<div class="text-center" style="color: #FF0000">Logout
						Successfully! Thanks for using contact application.</div>
				</c:if>
				<br>
				<div class="form-group">

					<form:input class="form-control text-center" path="email"
						placeholder="Username" title="Enter Username"
						data-toggle="tooltip" />
				</div>

				<div class="form-group">

					<form:password class="form-control text-center" path="pwd"
						placeholder="Password" title="Enter Password"
						data-toggle="tooltip" />
				</div>

				<input type="submit" id="userSaveBtn" value="Login"
					class="btn btn-success btn-block" onclick="validation(this);" />
				<br>
				<span class="login-style1"><a href="forgetPass"
					title="Send Registered Email" data-toggle="tooltip"><span
						style="color: white; font-weight: bolder;">Forget Password?</span></a></span>
			</form:form>
		</div>
	</div>
</div>
